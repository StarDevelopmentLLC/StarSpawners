package com.stardevllc.spawners.base;
...
public enum NMSVersion {
    ...
    private static NMSVersion getCurrentVersion() {
        try {
            ...
            System.out.println("[StarSpawners] Detected NMS Version: " + version);
            return valueOf(version);
        } catch (Exception e) {
            System.out.println("[StarSpawners] NMS Version incompatible with this version of StarSpawners, is it up to date?");
